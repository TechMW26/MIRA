...
export const HEALTH_ENDPOINT = import.meta.env.VITE_HEALTH_ENDPOINT || 'http://142.112.39.215:50971/health';

// Protected Endpoint - Requires API Key (for PRO/Safety users)
export const PROTECTED_INFERENCE_BASE_URL = import.meta.env.VITE_PROTECTED_INFERENCE_BASE_URL || 'http://142.112.39.215:50971';
...
export const PUBLIC_INFERENCE_BASE_URL = import.meta.env.VITE_PUBLIC_INFERENCE_BASE_URL || 'http://142.112.39.215:50971';
