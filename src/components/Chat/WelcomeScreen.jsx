import { Sparkles, Code, FileText, Image, Lightbulb, GraduationCap } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 pb-20">
      <div className="text-center mb-10">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-violet-500 to-purple-700 rounded-2xl mb-5 shadow-lg shadow-violet-500/20">
