...
const ALLOWED_MODELS = new Set(['seedream-pro']);
...
export async function GET(req) {
  ...
  const modelParam = String(url.searchParams.get('model') || 'seedream-pro').toLowerCase();
  const model = ALLOWED_MODELS.has(modelParam) ? modelParam : 'seedream-pro';
